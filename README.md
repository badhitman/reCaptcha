...
Внедрение:
Клиентскя/web часть интегрируется добавлением неболого количества скриптов. Можно внедрить в мастер страницу в самый конец _Layout.cshtml либо внедрив только на некоторые страницы
```html
