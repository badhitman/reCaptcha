...
>> Имейте ввиду! этот привязчик хорошо работает в ASP.Net Core 2.2, но не в ASP.Net Core 3.1 Web-Api. При использовании в данном типе проектов я на стороне клиента "исправляю" имя поля "с девисами" на "подчёркивание".
