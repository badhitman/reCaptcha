...
- v2 - привычная/классическая капча. Задачки с выбором картинок и прочие проверочные "тесты зрения и нервов пользователя". Эта версия может работать в одном из режимов:
	...
	- ["скрытый"](https://developers.google.com/recaptcha/docs/invisible), в этом режиме вы разрешаете reCaptcha самостоятельно решить: запрашивать/показывать задачки пользователю или нет
